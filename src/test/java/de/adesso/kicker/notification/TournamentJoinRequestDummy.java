...
public class TournamentJoinRequestDummy {
    ...
    public TournamentJoinRequest defaultTournamentJoinRequest = new TournamentJoinRequest((Tournament)singleElimDummy.defaultSingleElim(), userDummy.defaultUser(), userDummy.alternateUser(), teamDummy.defaultTeam());
}
