...
public class NotificationService {
    ...
    @Autowired
    public NotificationService(NotificationRepository notificationRepository, VerifyMatchService  verifyMatchService, UserService userService){
    ...
    public void declineNotification(long notificationId){
        ...
        switch (notification.getType()){
            ...
            case MATCH_VERIFICATION:
                ...
                for(User user : users) {
                    sendNotification(null, user, userService.getLoggedInUser().getFirstName() + " hat die Anfrage für das Match am "
